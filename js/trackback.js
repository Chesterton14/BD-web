window.onload=function(){
				...
				document.getElementById("input").addEventListener('click',function(e){
					...
					document.querySelector('.iconClose').style.display='block';
					document.querySelector('.timeSelect').style.display='block';
					document.querySelector('.iconMenu').style.display='none';
					document.querySelector('.iconBtn').style.display='block';
				});
				document.querySelector('.iconClose').addEventListener('click',function(e){
					document.getElementById('container').style.display="block";
					document.querySelector('.iconClose').style.display='none';
					document.querySelector('.timeSelect').style.display='none';
					document.querySelector('.iconMenu').style.display='block';
					document.querySelector('.iconBtn').style.display='none';
				});
				document.querySelector('.iconBtn').addEventListener('click',function(e){
					console.log(e);
					document.getElementById('container').style.display="block";
					document.querySelector('.iconClose').style.display='none';
					document.querySelector('.timeSelect').style.display='none';
					...
					setTimeout(function(){
						$.ajax({
						type: 'GET',
						url: 'http://119.29.144.11:3000/json/points.json',
					...
					function showInfo(thisMaker, point) {
						var sContent =
							...
							"<li style='line-height: 26px;font-size: 15px;'><span style='width: 50px;display: inline-block;'>状态：</span>" + point.time +
							"</li>" +
							"</ul>";
